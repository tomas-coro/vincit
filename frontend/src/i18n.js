...
const TRANSLATIONS = {
  it: {
    ...
    settings: {
      ...
      theme:'Tema', theme_dark:'🌙 Scuro', theme_light:'☀️ Chiaro', theme_amber:'🥃 Ambra', theme_selva:'🌿 Selva', theme_sakura:'🌸 Sakura', theme_pece:'🖤 Pece', theme_desc:"Cambia aspetto dell'app",
  ...
  en: {
    ...
    settings: {
      ...
      theme:'Theme', theme_dark:'🌙 Dark', theme_light:'☀️ Light', theme_amber:'🥃 Amber', theme_selva:'🌿 Selva', theme_sakura:'🌸 Sakura', theme_pece:'🖤 Pece', theme_desc:'Change the app appearance',
