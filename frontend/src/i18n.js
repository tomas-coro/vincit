...
const TRANSLATIONS = {
  it: {
    ...
    app:     { welcome_back:'Bentornato', credits:'Crediti', switch:'Switch', new_bet:'+ Nuova Bet', new_bet_label:'Nuova', new_group:'+ Nuovo gruppo', error_create:'Errore nella creazione della bet. Riprova.', error_cancel:"Errore durante l'annullamento. Riprova.", error_expired_cancel:'Non puoi annullare una bet scaduta — solo un admin del gruppo può farlo.', error_edit:'Errore durante la modifica. Riprova.', error_reset:'Errore durante il reset. Riprova.', error_accept:"Errore durante l'accettazione. Riprova.", error_counter:'Errore durante la puntata. Riprova.', error_reject:'Errore durante il rifiuto. Riprova.', reject_confirm:'Rifiutare questa bet?', sync_error:'Errore di sincronizzazione — tocca per riprovare', offline_banner:'📡 Sei offline — i dati potrebbero non essere aggiornati', ok_created:'Bet creata!', ok_edited:'Bet modificata', ok_cancelled:'Bet annullata', ok_accepted:'Bet accettata', ok_rejected:'Bet rifiutata', ok_reset:'Stagione resettata', ok_profile_saved:'Profilo aggiornato', err_role:'Impossibile cambiare ruolo', err_perms:'Impossibile aggiornare i permessi', undo:'Annulla', resolve_pending_won:'✅ "{title}" segnata come vinta — annulla entro 5s', resolve_pending_lost:'❌ "{title}" segnata come persa — annulla entro 5s', resolve_undone:'Risoluzione annullata', verify_email_banner:'Verifica la tua email per proteggere l\'account', verify_email_resend:'Invia di nuovo', verify_email_sent:'Email di verifica inviata ✓', verify_email_error:'Invio non riuscito. Riprova più tardi.' },
