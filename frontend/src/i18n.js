...
const TRANSLATIONS = {
  it: {
    ...
    trophies: {
      ...
      // Positive
      wins:'Vittorie',                wins_desc:'Bet vinte totali. Sali fino a 250.',
      win_streak:'Win Streak',        win_streak_desc:'Vittorie consecutive. Lv max = 25 di fila.',
      volume:'Esperienza',            volume_desc:'Bet risolte totali. Più giochi, più sali.',
      earnings:'Guadagno cumulativo', earnings_desc:'Crediti netti vinti in bet (somma di tutte le vincite).',

      // Challenge
      high_odds:'Outsider',           high_odds_desc:'Vittoria sulla quota più alta. Lv max = quota 20.',
      daredevil:'Spericolato',        daredevil_desc:'Vittorie su quota ≥ 5. Lv max = 100 vittorie alte.',
      safe_bet:'Conservatore',        safe_bet_desc:'Vittorie su quota ≤ 1.30. Lv max = 250 piccole certezze.',
      ...
      // Mission
      surprise:'Sorpresa',            surprise_desc:'Bet sorpresa create e risolte. Lv max = 50.',
      pegno:'Pegno saldato',          pegno_desc:'Bet con pegno vinte. Lv max = 50.',
      night_owl:'Nottambulo',         night_owl_desc:'Bet create tra mezzanotte e le 5. Lv max = 100.',
      early_bird:'Mattiniero',        early_bird_desc:'Bet create prima delle 8. Lv max = 100.',
      marathon:'Maratona',            marathon_desc:'Bet create in un solo giorno. Lv max = 50 in 24h.',
      ...
      loss_streak:'Loss Streak',      loss_streak_desc:'Sconfitte consecutive massime. Lv max = 25 di fila.',
      worst_loss:'Tonfo',             worst_loss_desc:'Stake più grande perso in una bet. Lv max = 1000 ₡.',
      outsider_lost:'Ironia della sorte', outsider_lost_desc:'Perse su quota ≥ 5 ("era sicura!"). Lv max = 20.',

      // Social
      flamed:'Iconico',               flamed_desc:'Tue bet ricevute 🔥. Lv max = 100.',
      paparazzo:'Paparazzo',          paparazzo_desc:'Foto-reazioni inviate. Lv max = 100.',
      counter_winner:'Sfidante',      counter_winner_desc:'Counter-bet vinte. Lv max = 250.',
      targeted:'Bersaglio',           targeted_desc:'Sei stato target di bet risolte. Lv max = 50.',
      multi_group:'Multi-gruppo',     multi_group_desc:'Gruppi di cui sei membro. Lv max = 20 gruppi.',
      recruiter:'Reclutatore',        recruiter_desc:'Persone entrate in tuoi gruppi. Lv max = 25.',
    },
    templates: {
  ...
  en: {
    ...
    trophies: {
      ...
      wins:'Wins',                    wins_desc:'Total bets won. Climb up to 250.',
      win_streak:'Win Streak',        win_streak_desc:'Consecutive wins. Lv max = 25 in a row.',
      volume:'Experience',            volume_desc:'Total resolved bets. The more you play, the higher.',
      earnings:'Cumulative earnings', earnings_desc:'Net credits won across all winning bets.',

      high_odds:'Outsider',           high_odds_desc:'Highest odds you won at. Lv max = odds 20.',
      daredevil:'Daredevil',          daredevil_desc:'Wins on odds ≥ 5. Lv max = 100 daring wins.',
      safe_bet:'Conservative',        safe_bet_desc:'Wins on odds ≤ 1.30. Lv max = 250 safe wins.',
      ...
      surprise:'Surprise',            surprise_desc:'Surprise bets created and resolved. Lv max = 50.',
      pegno:'Forfeit paid',           pegno_desc:'Bets with a forfeit won. Lv max = 50.',
      night_owl:'Night owl',          night_owl_desc:'Bets created between midnight and 5am. Lv max = 100.',
      early_bird:'Early bird',        early_bird_desc:'Bets created before 8am. Lv max = 100.',
      marathon:'Marathon',            marathon_desc:'Bets created in a single day. Lv max = 50 in 24h.',
      ...
      worst_loss:'Big drop',          worst_loss_desc:'Biggest stake lost in a single bet. Lv max = 1000 ₡.',
      outsider_lost:'Cruel irony',    outsider_lost_desc:'Lost on odds ≥ 5 (sure thing!). Lv max = 20.',

      flamed:'Iconic',                flamed_desc:'Your bets that got 🔥. Lv max = 100.',
      paparazzo:'Paparazzo',          paparazzo_desc:'Photo reactions sent. Lv max = 100.',
      counter_winner:'Counter king',  counter_winner_desc:'Counter-bets won. Lv max = 250.',
      targeted:'Moving target',       targeted_desc:'You were the target of resolved bets. Lv max = 50.',
      multi_group:'Multi-group',      multi_group_desc:'Groups you belong to. Lv max = 20.',
      recruiter:'Recruiter',          recruiter_desc:'People who joined groups you own. Lv max = 25.',
    },
    templates: {
