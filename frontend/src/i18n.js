...
const TRANSLATIONS = {
  it: {
    ...
    trophies: {
      ...
      commentator:'Commentatore',     commentator_desc:'Commenti su tue bet risolte.',
    ...
    photo: {
      ...
      err_denied:'Permesso fotocamera negato · controlla le impostazioni del browser',
    ...
    friends: {
      title:'Amici',
      subtitle:'Tutte le persone con cui hai condiviso almeno un gruppo. Invitale al volo in altri gruppi dove sei admin.',
      loading:'Caricamento amici…',
      search:'Cerca per nome…',
      empty_title:'Ancora nessun amico',
      empty_body:'Non appena qualcuno si unisce a uno dei tuoi gruppi, comparirà qui — pronto per essere invitato altrove.',
      no_results:'Nessuno corrisponde alla ricerca',
      ...
      no_eligible:'Sei già nel gruppo con questa persona in tutti i tuoi gruppi (o non hai il permesso di aggiungere membri).',
  ...
  en: {
    ...
    trophies: {
      ...
      commentator:'Commentator',      commentator_desc:'Comments on your resolved bets.',
    ...
    friends: {
      title:'Friends',
      subtitle:'Everyone you have shared at least one group with. Invite them to any other group where you are admin.',
      loading:'Loading friends…',
      search:'Search by name…',
      empty_title:'No friends yet',
      empty_body:'As soon as someone joins one of your groups, they will show up here, ready to be invited elsewhere.',
      no_results:'No one matches that search',
