...
const TRANSLATIONS = {
  it: {
    ...
    settings: {
      ...
      intro_push_label:'Notifiche', intro_push_body:'Push per nuove bet, risoluzioni, sfide. Tutto disattivabile.',
      ...
      intro_cats_label:'Categorie', intro_cats_body:'Le 4 stock (Sport, Media, Vita, Altro) non si cancellano, ma puoi creare le tue categorie personalizzate.',
      intro_vault_label:'Vault PIN', intro_vault_body:'Proteggi le tue bet private con un codice 4 cifre.',
      ...
      theme:'Tema', theme_dark:'🌙 Scuro', theme_light:'☀️ Chiaro', theme_amber:'🥃 Ambra', theme_desc:"Cambia aspetto dell'app",
    ...
    group_info: {
      ...
      share_link_msg:'Entra nel mio gruppo BetCouple "{name}" {emoji}: {url}',
  ...
  en: {
    ...
    settings: {
      ...
      intro_push_label:'Notifications', intro_push_body:'Push for new bets, resolutions, challenges. All toggleable.',
      ...
      intro_cats_label:'Categories', intro_cats_body:"The 4 stock cats (Sport, Media, Vita, Altro) can't be removed, but you can add your own custom ones.",
      ...
      theme:'Theme', theme_dark:'🌙 Dark', theme_light:'☀️ Light', theme_amber:'🥃 Amber', theme_desc:'Change the app appearance',
    ...
    group_info: {
      ...
      share_link_msg:'Join my BetCouple group "{name}" {emoji}: {url}',
